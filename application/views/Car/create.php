                    ...
                    <div class="" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Agregar Auto - Folio No <?php echo $id ?></h5>
                          </button>
                        </div>
                          <div class="modal-body">
                            <form action="<?php echo base_url(); ?>Car/create" method="post">
                              <div class="row">
                                <div class="col-md-6 pr-2">
                                  <div class="form-group">
                                    <input type="hidden" name="ManttoId" class="form-control" placeholder="" value="<?php echo $manttoid ?>" readonly>
                                  </div>
                                </div>
                              </div>
                              <div class="row">
