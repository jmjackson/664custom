        ...
        <div class="places-buttons">
          <div class="row">
            <div class="col-md-6 ml-auto mr-auto text-center">
              <h4 class="card-title m-0">Principal
                <p class="category">Bienvenido <?php echo $this->session->FullName ?></p>
              </h4>
            </div>
          </div>
          <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                          <div class="numbers">
                            ...
                            <p class="card-title">Recibos</p><p>
                          </p></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body text-white">
                      <div class="row">
                        <div class="col-4 col-md-4">
                          <div class="icon-big text-center icon-warning">
                            <i class="nc-icon nc-support-17 text-warning"></i>
                          </div>
                        </div>
                        <div class="col-8 col-md-8">
                          <div class="numbers">
                            <p class="card-category text-white">Gestión</p>
                            <p class="card-title">Servicios</p><p>
                          </p></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body text-white">
                      <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                          <div class="numbers">
                            <p class="card-category text-white">Gestión</p>
                            <p class="card-title">Proveedor</p><p>
                          </p></div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="card-body text-white">
                      <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                          <div class="numbers">
                            <p class="card-category text-white">Gestión</p>
                            <p class="card-title">Mantto</p><p>
                          </p></div>
                        </div>
                      </div>
                    </div>
                    <a href="<?php echo base_url(); ?>ServicesAdmin">
                    <div class="card-footer ">
                      <hr>
                      <div class="stats text-white">
                        <i class="fa fa-arrow-right text-white"></i>
